...
<body dir="rtl">
    <div class="container">
        <div class="title">اضافة نقطة سيريتيل جديدة</div>
        <form action="addsyr.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="button">
                ...
                <a href="syr.php">
                    <input type="button" value="الرجوع لإعدادات سيريتيل " class="inp2">
                </a>
            </div>
        </form>
    </div>
