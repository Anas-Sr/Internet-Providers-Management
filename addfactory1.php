...
if (isset($_POST['add'])) {
    ...
    if (!empty($name) && !empty($email)  && !empty($pass) && !empty($address)) {
        $sql = "INSERT INTO manufactory (man_name,image,man_email,pass,man_information,status)
    VALUES ('$name','$newimage','$email','$pass','$address','$kind')";
