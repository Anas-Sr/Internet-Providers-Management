...
<body dir="rtl">
    ...
    <div class="table-container">
        <h1 class="heading">جميع خدمات التسديد</h1>
        <form action="payment-factory.php" method="POST">
            <input type="search" name="name" placeholder=" ابحث عن أي خدمة تسديد" style="    
    width: 350px;
    margin-right:40px;
    line-height: 35px;
    ...
    margin-top: 15px;
    box-shadow: 10px 10px 5px rgba(0, 0, 0, 0.25);
        "><a href="addp_factory.php" style="color: white; text-decoration: none;">
                اضافة نقطة تسديد جديدة <i class="fa fa-plus"></i></a>
        </button>
        <button style="
        width: 170px;
    text-decoration: none;
