...
if (isset($_POST['search']) && !empty($_POST['name'])) {
    $search = $_POST['name'];
    $sql = "SELECT * FROM manufactory WHERE kind = 2 AND man_name LIKE '$search%' ";
...
?>
        ...
        echo "<div style='text-align:center; padding: 8px; font-size: 20px; font-weight: bolder;'>" . "لا توجد نقطة سيريتيل بهذا الاسم" . "</div>";
    }
}
        ?>