...
<body dir="rtl">
    <div class="container">
        <div class="title">اضافة وكيل جديد</div>
        <form action="addwakeel.php" method="POST">
            <div class="user-details">
                <div class="input-box">
                    <span class="details">الاسم الكامل <span style="color: red;">*</span></span>
                    <input type="text" name="name" placeholder="أدخل اسم الوكيل كاملا..." required>
                </div>
                <div class="input-box">
                ...
                <div class="input-box">
                    ...
                    <input type="text" class="phone-field" name="tel" placeholder="أدخل رقم الهاتف كاملا..." required>
                </div>
                <div class="input-box">
            ...
            <div class="button">
                ...
                <a href="wakeel.php">
                    <input type="button" value="الرجوع لصفحة الوكلاء " class="inp2">
                </a>
            </div>
        </form>
    </div>
