<?php
include 'conn.php';
$sql = "SELECT * FROM allaccount WHERE kind = 1";
        ...
        <tr>
            ...
            <td data-label="العمليات | الحالة">
                ...
                if ($result['status'] == 1) {
                    ...
                    echo "<a href='persondown.php?id=$id' class='btn' style='background-color:red; width: 120px;'>غير مفعل</a>";
                }
                ?>
...
<?php
    ...
    echo "<div style='text-align:center; padding:5px; font-size: 25px; font-weight:bold; font-style:italic;'>" . "لا يوجد وكلاء حاليا" . "</div>";
}
?>