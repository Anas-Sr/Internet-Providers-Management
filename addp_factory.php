...
<body dir="rtl">
    <div class="container">
        <div class="title">اضافة نقطة تسديد جديدة</div>
        <form action="addp_factory.php" method="POST" enctype="multipart/form-data">
            <div class="user-details">
                <div class="input-box">
                    <span class="details">اسم نقطة التسديد الجديدة <span style="color: red;">*</span></span>
            ...
            <div class="button">
                ...
                <a href="payment-factory.php">
                    <input type="button" value="الرجوع لصفحة خدمات التسديد " class="inp2">
                </a>
            </div>
        </form>
    </div>
